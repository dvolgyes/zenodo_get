...
# New Test Case 1: Download .bib and .xml files
echo "Running Test Case 1: Download .bib and .xml files"
$CMD -- 1215979 -g "*.bib,*.xml" -o test_bib_xml_output -n
...
# New Test Case 2: Download only .ipynb files
echo "Running Test Case 2: Download only .ipynb files"
